...
public class CameraPlugin implements MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, final Result result) {
        switch (call.method) {
            ...
            case "startVideoRecording": {
                ...
                camera.startVideoRecording(filePath, result, getCamcorderProfile());
                break;
            }
    ...
    private CamcorderProfile getCamcorderProfile() {
        ...
        CamcorderProfile camcorderProfileAudio;
        ...
        if (CamcorderProfile.hasProfile(CamcorderProfile.QUALITY_720P)) {
            camcorderProfileAudio = CamcorderProfile.get(CamcorderProfile.QUALITY_720P);
        } else {
            camcorderProfileAudio = CamcorderProfile.get(CamcorderProfile.QUALITY_HIGH);
        }
        camcorderProfile.audioBitRate = camcorderProfileAudio.audioBitRate;
        camcorderProfile.audioChannels = camcorderProfileAudio.audioChannels;
        camcorderProfile.audioCodec = camcorderProfileAudio.audioCodec;
        camcorderProfile.audioSampleRate = camcorderProfileAudio.audioSampleRate;
        camcorderProfile.fileFormat = MediaRecorder.OutputFormat.MPEG_4;
        camcorderProfile.videoCodec = MediaRecorder.VideoEncoder.H264;
        camcorderProfile.audioCodec = MediaRecorder.AudioEncoder.AAC;
        camcorderProfile.videoBitRate = 1_000_000;
        camcorderProfile.audioBitRate = 128_000;
    ...
    private class Camera {
        ...
        private void prepareMediaRecorder(String outputFilePath, CamcorderProfile camcorderProfile) throws IOException {
            if (mediaRecorder != null) {
                mediaRecorder.release();
            }
            if (BuildConfig.DEBUG) {
                Log.i("CameraPlugin", "CamcorderProfile.fileFormat: " + camcorderProfile.fileFormat);
                Log.i("CameraPlugin", "CamcorderProfile.videoCodec: " + camcorderProfile.videoCodec);
                Log.i("CameraPlugin", "CamcorderProfile.videoBitRate: " + camcorderProfile.videoBitRate);
                Log.i("CameraPlugin", "CamcorderProfile.videoFrameRate: " + camcorderProfile.videoFrameRate);
                Log.i("CameraPlugin", "CamcorderProfile.videoFrameWidth: " + camcorderProfile.videoFrameWidth);
                Log.i("CameraPlugin", "CamcorderProfile.videoFrameHeight: " + camcorderProfile.videoFrameHeight);
                Log.i("CameraPlugin", "CamcorderProfile.audioCodec: " + camcorderProfile.audioCodec);
                Log.i("CameraPlugin", "CamcorderProfile.audioBitRate: " + camcorderProfile.audioBitRate);
                Log.i("CameraPlugin", "CamcorderProfile.audioSampleRate: " + camcorderProfile.audioSampleRate);
                Log.i("CameraPlugin", "CamcorderProfile.audioChannels: " + camcorderProfile.audioChannels);
            }
        ...
        private void startVideoRecording(String filePath, @NonNull final Result result, CamcorderProfile camcorderProfile) {
            ...
            try {
                closeCaptureSession();
                prepareMediaRecorder(filePath, camcorderProfile);
